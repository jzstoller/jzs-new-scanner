...
This applies a manila page background with black pen styling and recolors embedded images in your note content.

> **Important:** CSS-based recoloring does not affect exported scans from this plugin. Use your theme's built-in image treatment or post-process the image outside Obsidian if you need recoloring.
